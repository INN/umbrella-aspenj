				...
				<div class="container">
					...
					<?php } ?>
						...
						<ul id="header-extras">
                            <?php
                            /*
                            * Display Subscribe button formatted specifically for the sticky navbar
                            */
                            if( function_exists( 'aspen_subscribe_button' ) ) { ?>
                            <li class="subscribe">
                                <?php aspen_subscribe_button( $location = 'sticky' ); ?>
                            </li>
                            <?php }
							/*
